...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'wine_userprofile', 'first_name')

        # Deleting field 'UserProfile.last_name'
        db.delete_column(u'wine_userprofile', 'last_name')

        # Adding field 'UserProfile.name'
        db.add_column(u'wine_userprofile', 'name',
                      self.gf('django.db.models.fields.TextField')(default='Sample User'),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'wine_userprofile', 'name')
