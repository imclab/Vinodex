...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Wine.winery'
        db.alter_column(u'wine_wine', 'winery_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wine.Winery']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Wine.winery'
        raise RuntimeError("Cannot reverse this migration. 'Wine.winery' and its values cannot be restored.")
