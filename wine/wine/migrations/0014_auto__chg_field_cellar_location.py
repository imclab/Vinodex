...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cellar.location'
        db.alter_column(u'wine_cellar', 'location', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Cellar.location'
        raise RuntimeError("Cannot reverse this migration. 'Cellar.location' and its values cannot be restored.")
