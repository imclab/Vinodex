...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wine_userprofile', (
        ...
        db.send_create_signal(u'wine', ['UserProfile'])
        ...
        db.create_table(u'wine_cellar', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wine.UserProfile'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'wine_userprofile')
