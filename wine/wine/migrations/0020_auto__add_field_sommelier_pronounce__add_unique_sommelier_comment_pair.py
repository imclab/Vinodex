...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sommelier.pronounce'
        db.add_column(u'wine_sommelier', 'pronounce',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Sommelier', fields ['comment', 'pairing', 'wine_type']
        db.create_unique(u'wine_sommelier', ['comment', 'pairing', 'wine_type'])


    def backwards(self, orm):
        # Removing unique constraint on 'Sommelier', fields ['comment', 'pairing', 'wine_type']
        db.delete_unique(u'wine_sommelier', ['comment', 'pairing', 'wine_type'])

        # Deleting field 'Sommelier.pronounce'
        db.delete_column(u'wine_sommelier', 'pronounce')
    ...
    models = {
        ...
        'wine.sommelier': {
            'Meta': {'unique_together': "(['wine_type', 'pairing', 'comment', 'pairing'],)", 'object_name': 'Sommelier'},
            'comment': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pairing': ('django.db.models.fields.TextField', [], {}),
            'pronounce': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
