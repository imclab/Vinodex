...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Sommelier'
        db.create_table(u'wine_sommelier', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('wine_type', self.gf('django.db.models.fields.TextField')()),
            ('pairing', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'wine', ['Sommelier'])


    def backwards(self, orm):
        # Deleting model 'Sommelier'
        db.delete_table(u'wine_sommelier')
