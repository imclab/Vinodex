...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wine.alcohol_content'
        db.add_column(u'wine_wine', 'alcohol_content',
                      self.gf('django.db.models.fields.FloatField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Wine.alcohol_content'
        db.delete_column(u'wine_wine', 'alcohol_content')
