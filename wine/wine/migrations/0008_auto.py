...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Winery', fields ['name']
        db.create_index(u'wine_winery', ['name'])

        # Adding index on 'Wine', fields ['name']
        db.create_index(u'wine_wine', ['name'])

        # Adding index on 'Wine', fields ['vintage']
        db.create_index(u'wine_wine', ['vintage'])


    def backwards(self, orm):
        # Removing index on 'Wine', fields ['vintage']
        db.delete_index(u'wine_wine', ['vintage'])

        # Removing index on 'Wine', fields ['name']
        db.delete_index(u'wine_wine', ['name'])

        # Removing index on 'Winery', fields ['name']
        db.delete_index(u'wine_winery', ['name'])
