...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SommelierTable'
        db.create_table(u'wine_sommeliertable', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('wine_type', self.gf('django.db.models.fields.TextField')()),
            ('pairing', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'wine', ['SommelierTable'])


    def backwards(self, orm):
        # Deleting model 'SommelierTable'
        db.delete_table(u'wine_sommeliertable')
    ...
    models = {
        ...
        u'wine.sommeliertable': {
            'Meta': {'object_name': 'SommelierTable'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'wine.wine': {
            ...
            'winery': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'wines'", 'to': u"orm['wine.Winery']"})
        },
        u'wine.winery': {
