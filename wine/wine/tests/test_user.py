...
class UserTestCase(unittest.TestCase):
    ...
    def create_user1(self):
        return self.helper.postOK("/api/v1/user/?format=json", self.sample_user1)

    def create_user2(self):
        return self.helper.postOK("/api/v1/user/?format=json", self.sample_user2)

    def create_user3(self):
        return self.helper.postOK("/api/v1/user/?format=json", self.sample_user3)

    def create_user4(self):
        return self.helper.postOK("/api/v1/user/?format=json", self.sample_user4)
