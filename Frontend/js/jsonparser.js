    ...
    function buildList(data, isSub) {
        ...
        for (item in data) {
            if (typeof (data[item]) === "object") { // An array will return "object"
                html += "<li class=\"expand\">" + item + " {" + buildList(data[item], false) + "}"; // Submenu found. Calling recursively same method (and wrapping it in a div)
            } else {
                html += "<li>" + item + " : " + data[item] // No submenu
            }
            html += "</li>";
        }
        html += "</ul>";
